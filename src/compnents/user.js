...
const Employees = () => {
    ...
    const createEmployee = async () => {
        const response = await axios.post(`${BACKEND_URL}/create`, employeeObj);
                                    ...
                                    <div className="col-7">
                                        ...
                                        <div className="row">
                                            <div className="col-4">
                                                ...
                                                <input type="number"  value={employeeObj.employeeId}  onChange={(event) => { updateEmpFormValues(event, 'employeeId') }} className="form-control"
                                            ...
                                            empList.map((item, index) => {
                                                return (<tr>
                                                   ...
                                                   <td>{item.type}</td>
                                                    ...
                                                    <td>
                                                        <button className='btn btn-sm btn-primary' onClick={()=>{getEmployeeById(item.employeeId)}}>Edit</button>
                                                        <button className='btn btn-sm btn-danger mx-2' onClick={()=>{deletEmp(item.employeeId)}}>Delete</button>
                                                    </td>
                                                </tr>)
                                            })
                                        }
